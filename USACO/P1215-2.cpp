...
void dfss(int * a, int * b,int * c){
 ...
 for (int i = 1;i<=3;i++){
  for(int j = 1;j<=3;j++){
   if(i!=j){
    if(i==1&&j==2){if(a[2]!=0 && b[2]!=b[1]) {add_milk (a,b);}}
    else if(i==1&&j==3){if(a[2]!=0 && c[2]!=c[1]) {add_milk (a,c);}}
    else if(i==2&&j==1){if(b[2]!=0 && a[2]!=a[1]) {add_milk (b,a);}}
    else if(i==2&&j==3){if(b[2]!=0 && c[2]!=c[1]) {add_milk (b,c);}}
    else if(i==3&&j==1){if(c[2]!=0 && a[2]!=a[1]) {add_milk (c,a);}}
    else if(i==3&&j==2){if(c[2]!=0 && b[2]!=b[1]) {add_milk (c,b);}}
    if(a[2]==0 && ans[c[2]]==0){
     ans[c[2]]=1;
     num++;
    }
